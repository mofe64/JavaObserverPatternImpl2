...
public class Main {
    public static void main(String[] args) {
        ...
        List<Number> dataSource1 = DataSource.getMockDataSource();
        DataSource.populateMockDataSource(1_000, 100, 3);
        List<Number> dataSource2 = DataSource.getMockDataSource();
        DataSource.populateMockDataSource(1_000, 100, 4);
        List<Number> dataSource3 = DataSource.getMockDataSource();
        dataSource3.add(3);
        Number searchQuery = 3;
